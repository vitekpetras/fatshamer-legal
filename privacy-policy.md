...
- Můžeš svůj **účet kdykoli smazat** (Nastavení → Profil → Smazat účet) <!-- TODO GPLAY_4: link delete account flow path -->.
...
V aplikaci v **Nastavení → Profil → Smazat účet** <!-- TODO GPLAY_4: link path --> si můžeš okamžitě smazat účet. Co se stane:
...
- **Lokální data** v zařízení jsou smazána při následujícím odhlášení nebo odinstalaci.
